...
class SelesaiPenduduk extends StatefulWidget {
  @override
  _SelesaiPendudukState createState() => _SelesaiPendudukState();
}

class _SelesaiPendudukState extends State<SelesaiPenduduk> {
  Widget suratWidget(
  ...
  Future<List<Map<String, dynamic>>> _getListData() async {
    SelesaipPresenter todoPresenter = new SelesaipPresenter();
    var allData = await todoPresenter.getSelesaiSurat();
    if (allData.isEmpty) {
      return null;
    } else {
      return allData;
